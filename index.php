...
<head>
    ...
    <script src="http:/ecommerce/admin_area/js/bootstrap-filestyle.min.js"> </script>
...
<div class="container wrapper container-fluid" ng-cloak="">
      ...
      <li id="products-menu"><a ng-href="#/products/{{'all'}}"> Products </a></li>
        ...
        <li id="social dropdown categories-menu">
              ...
              <ul class="dropdown-menu" role="menu">
                  <li><a ng-href="/ecommerce/#/products/{{'phone'}}">       Phone        </a></li>
        ...
        <li id="admin-menu"><a ng-href="/ecommerce/admin_area/"><span class="glyphicon glyphicon-user"> Administrator </a></li>
     <!-- End Menubar -->
